...
def pytest_addoption(parser):
    ...
    parser.addoption(
        "--mender-client-version-inventory-script-deb-version", required=False
    )
...
@pytest.fixture(scope="session")
def mender_client_version_inventory_script_version(request):
    return request.config.getoption("--mender-client-version-inventory-script-version")
